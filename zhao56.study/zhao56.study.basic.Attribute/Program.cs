        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                #region MyRegion
                {
                    ...
                    //绑定界面--UserState.Frozen：已冻结
                    //英文单词--数字值---中文描述
                    //UserState.正常状态.ToString();
                    ...
                    //string reamrk = AttributeExtend.GetRemark(userState);
                ...
                }
                {
                    ...
                    //单个字段数据验证可以。begindate enddate 2个字段联合验证，如何做特性验证？比如判断2个日期不能大于30天？这个好像没法通用，只能写普通方法验证。
                }
                #endregion
            }
            catch (Exception ex)
